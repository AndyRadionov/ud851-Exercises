...
public class NotificationUtils {
    public static final int WATER_PENDING_INTENT_ID = 4242;
    public static final int WATER_NOTIFICATION_ID = 4212;
    public static final String WATER_NOTIFICATION_CHANNEL_ID = "waterNotificationChannel";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (osVersion >= Build.VERSION_CODES.O) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(
                context, WATER_NOTIFICATION_CHANNEL_ID)
        ...
        if (osVersion > Build.VERSION_CODES.JELLY_BEAN && osVersion < Build.VERSION_CODES.O) {
