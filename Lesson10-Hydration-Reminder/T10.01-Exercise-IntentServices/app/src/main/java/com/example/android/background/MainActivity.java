...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent startWaterServiceIntent = new Intent(this, WaterReminderIntentService.class);
        startWaterServiceIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        // COMPLETED (17) Call startService and pass the explicit intent you just created
        startService(startWaterServiceIntent);
    }
