...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        } else if (key.equals(getString(R.string.pref_min_size_key))) {
            loadSize(sharedPreferences);
        }
    }

    private void loadSize(SharedPreferences preferences) {
        float minSize = Float.parseFloat(preferences.getString(getString(R.string.pref_min_size_key), getResources().getString(R.string.pref_min_size_default)));
