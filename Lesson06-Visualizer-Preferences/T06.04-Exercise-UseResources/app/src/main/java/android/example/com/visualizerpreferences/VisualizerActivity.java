...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        boolean showBassDefault = getResources().getBoolean(R.bool.pref_show_bass_default);
        String showBassKey = getResources().getString(R.string.pref_show_bass_key);
        boolean showBassPref = sharedPreferences.getBoolean(showBassKey, showBassDefault);

        mVisualizerView.setShowBass(showBassPref);
