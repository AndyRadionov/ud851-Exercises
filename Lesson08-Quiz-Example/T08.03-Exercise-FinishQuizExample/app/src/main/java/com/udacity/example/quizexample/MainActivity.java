...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mWordDisplay;
    private TextView mDefinitionDisplay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWordDisplay = (TextView) findViewById(R.id.text_view_word);
        mDefinitionDisplay = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        if (mData != null) {
            ...
            if (mData.moveToNext() || mData.moveToFirst()) {
                ...
                mWordDisplay.setText(word);
                mDefinitionDisplay.setVisibility(View.INVISIBLE);
                mDefinitionDisplay.setText(definition);
            }
        }
    ...
    public void showDefinition() {
        ...
        mDefinitionDisplay.setVisibility(View.VISIBLE);
