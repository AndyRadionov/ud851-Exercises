...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BoardingPassInfo fakeDate = FakeDataUtils.generateFakeBoardingPassInfo();

        // COMPLETED (9) Call displayBoardingPassInfo and pass the fake BoardingInfo instance
        displayBoardingPassInfo(fakeDate);
    }
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        DateFormat dateFormat = new SimpleDateFormat(getString(R.string.timeFormat), Locale.getDefault());
